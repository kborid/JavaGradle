    ...
    public static boolean canRunRootCommands() {
        ...
        try {
            ...
            if (null == currUid) {
                retval = false;
                exitSu = false;
                System.out.println("Can't get root access or denied by user");
                ...
                retval = false;
                exitSu = true;
                System.out.println("Root access rejected: " + currUid);
            }
            ...
            retval = false;
            System.out.println("Root access rejected [" + e.getClass().getName() + "] : " + e.getMessage());
        }
